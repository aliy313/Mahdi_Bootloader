...
void boot_page_read(unsigned char _page_number); // Fill page_buffer[64] with Flash Page values . Data Order is High Word First (_page_number : Address number of Specified Page to Fill page_buffer[64] with its value)
...
void boot_page_write(unsigned char _page_number); // Write page_buffer[64] values to Specified Flash Page . Data Order is High Word First (_page_number : Address number of Specified Page to Write on it)
